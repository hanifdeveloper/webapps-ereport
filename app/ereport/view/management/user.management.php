                    ...
                    <div id="user" class="block full">
                            ...
                            <div class="form-group form-actions">
                                <div class="col-sm-4">
                                    <div class="input-group">
                                        ...
                                        <?= comp\BOOTSTRAP::inputText('cari', 'text', '', 'class="form-control filter-table" placeholder="Cari User ..."') ?>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>{group_user}</td>
                                            <td>
                                                <button data-toggle="tooltip" title="Edit Data" id="{id_user}" class="btn btn-effect-ripple btn-sm btn-success btn-edit"><i class="fa fa-pencil"></i></button>
                                                <button data-toggle="tooltip" title="Delete Data" id="{id_user}" class="btn btn-effect-ripple btn-sm btn-danger btn-delete" data-message="Yakin data user {username} akan dihapus ?"><i class="fa fa-times"></i></button>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                        ...
                        <form action="page_forms_components.html" method="post" class="fzform-content form-bordered" onsubmit="return false;" autocomplete="off">
                            <div class="form-group">
                                ...
                                <span data-form-object="username"></span>
                            </div>
                            <div class="form-group">
                                <label for="password">Password</label>
                                <span data-form-object="password"></span>
                                <span class="help-block">*) Digunakan untuk login ke aplikasi Web</span>
                            </div>
                            <div class="form-group">
                                <label for="group_user">Group</label>
                                <span data-form-object="group_user"></span>
                            </div>
                        </form>
                    </div>
